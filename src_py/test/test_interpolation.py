...
if sys.platform != 'win32':
    class TestInterpolator(unittest.TestCase):
        ...
        def test_P1(self):
            ...
            _, clothlist = G2lib.buildP1(XS, YS, THETA_0, THETA_1)
            self.assertEqual(len(clothlist), 6)
        ...
        def test_P2(self):
            ...
            _, clothlist = G2lib.buildP2(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P4(self):
            ...
            _, clothlist = G2lib.buildP4(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P5(self):
            ...
            _, clothlist = G2lib.buildP5(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P6(self):
            ...
            _, clothlist = G2lib.buildP6(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P7(self):
            ...
            _, clothlist = G2lib.buildP7(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P8(self):
            ...
            _, clothlist = G2lib.buildP8(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
        ...
        def test_P9(self):
            ...
            _, clothlist = G2lib.buildP9(XS, YS)
            self.assertEqual(len(clothlist), 6)
            theta_opt = self.get_theta(clothlist)
